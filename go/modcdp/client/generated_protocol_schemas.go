...
func (c *ModCDPClient) hydrateNativeProtocolSchemas() {
	...
	c.commandParamsSchemas["Extensions.loadUnpacked"] = abxjsonschema.SchemaFor[CDPParams]()
	c.commandResultSchemas["Extensions.loadUnpacked"] = nativeResultSchema(abxjsonschema.SchemaFor[CDPResult]())
