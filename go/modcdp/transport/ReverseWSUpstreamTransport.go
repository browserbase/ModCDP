...
type ReverseWSUpstreamTransport struct {
	UpstreamTransport
	URL           string
	WaitTimeoutMS int
...
func (t *ReverseWSUpstreamTransport) setBind(bind string) {
	raw := bind
...
func (t *ReverseWSUpstreamTransport) Connect() error {
...
func (t *ReverseWSUpstreamTransport) Send(message map[string]any) error {
...
func (t *ReverseWSUpstreamTransport) WaitForPeer() error {
	t.writeMu.Lock()
...
func (t *ReverseWSUpstreamTransport) PeerGeneration() int64 {
	t.stateMu.Lock()
	defer t.stateMu.Unlock()
	return t.generation
}

func (t *ReverseWSUpstreamTransport) Close() error {
	t.stateMu.Lock()
	closeCh := t.closeCh
	t.closeCh = make(chan struct{})
...
func (t *ReverseWSUpstreamTransport) acceptLoop() {
	for {
...
func (t *ReverseWSUpstreamTransport) accept(conn net.Conn) {
...
func (t *ReverseWSUpstreamTransport) resetPeerWait() {
	t.stateMu.Lock()
	defer t.stateMu.Unlock()
	t.peerCh = make(chan struct{})
	t.peerOnce = sync.Once{}
