...
func TestReverseWSUpstreamTransportCloseResetsPeerWaitState(t *testing.T) {
	port, err := freePort()
	if err != nil {
		t.Fatal(err)
	}
...
func TestReverseWSUpstreamTransportWaitsAgainAfterPeerDisconnects(t *testing.T) {
	port, err := freePort()
	if err != nil {
		t.Fatal(err)
	}
...
func TestReverseWSUpstreamTransportAcceptsReplacementPeerAfterDisconnect(t *testing.T) {
	port, err := freePort()
	if err != nil {
		t.Fatal(err)
	}
...
func TestReverseWSUpstreamTransportCloseRejectsPendingPeerWaits(t *testing.T) {
	port, err := freePort()
	if err != nil {
		t.Fatal(err)
	}
...
func waitForReversePeerDisconnect(t *testing.T, transport *ReverseWSUpstreamTransport) {
	t.Helper()
...
func TestReverseWSUpstreamTransportAcceptsRealExtensionReverseConnectionAndRoutesCDPThroughChromeDebugger(t *testing.T) {
	...
	transport, ok := cdp.Transport().(*ReverseWSUpstreamTransport)
	if !ok {
